...
import com.androiddevs.runningappyt.utils.CustomMarkerView
import com.androiddevs.runningappyt.utils.TrackingUtility
import com.androiddevs.runningappyt.viewmodel.StatisticsViewModel
...
class StatisticsFragment : Fragment(R.layout.fragment_statistics) {
    ...
    private fun subscribeToObserver() {
        ...
        viewModel.runSortedByDate.observe(viewLifecycleOwner, Observer {
            it?.let {
                val allAverageSpeed = it.indices.map { i -> BarEntry(i.toFloat(), it[i].avgSpeedInKMH) }
